            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>类型：</th>
                        <td>
                            <input type="radio" name="field_type" onclick="checkType(this)" value="input" checked>input&nbsp;
                            <input type="radio" name="field_type" onclick="checkType(this)" value="textarea">textarea&nbsp;
                            <input type="radio" name="field_type" onclick="checkType(this)" value="radio">radio&nbsp;

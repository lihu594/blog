...
@section('content')
	...
	<div class="menu_box">
		<ul>
            <li>
            	<h3><i class="fa fa-fw fa-cog"></i>内容管理</h3>
                <ul class="sub_menu">
            ...
            <li>
                ...
                <ul class="sub_menu">
					...
					<li><a href="{{url('admin/navs')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>导航栏列表</a></li>
					<li><a href="{{url('admin/config')}}" target="main"><i class="fa fa-fw fa-cogs"></i>配置项列表</a></li>
				</ul>
            </li>
            {{--<li>--}}
	...
	<div class="bottom_box">
		CopyRight © 2015. Powered By <a href="#">http://www.sevenbbs.com</a>.
	</div>
	<!--底部 结束-->
@endsection